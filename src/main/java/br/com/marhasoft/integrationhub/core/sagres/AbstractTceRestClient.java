...
public abstract class AbstractTceRestClient {
    ...
    protected final SagresProperties tceSagresProperties;

    protected final SagresErrorHandler errorHandler;
    ...
    /**
     * Registra o resultado funcional da integração.
     */
    protected void registrarResultado(SagresLogContext logContext, IntegrationResult result) {
        logContext.setResponse(null);
        logContext.setResult(result);

        SagresLogger.result(logContext);
    }
}