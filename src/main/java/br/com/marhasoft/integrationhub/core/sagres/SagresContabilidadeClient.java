 ...
 * já tenha sido criado pelo {@link SagresEnvioClient}.</p>
 *
 * <p>Enquanto o {@link SagresEnvioClient} gerencia o ciclo de vida do
 ...
 */
@Component
public class SagresContabilidadeClient extends AbstractTceRestClient {

    public SagresContabilidadeClient(AccessTokenService accessTokenService,
                                     SagresProperties tceSagresProperties, SagresErrorHandler errorHandler) {
