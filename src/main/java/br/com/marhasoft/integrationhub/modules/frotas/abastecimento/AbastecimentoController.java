 ...
 */
@RestController
@RequestMapping("/api/v1/frotas/abastecimentos")
@RequiredArgsConstructor
public class AbastecimentoController extends AbstractIntegrationController {
    ...
    public ResponseEntity<IntegrationResult> create(
            ...
            @Valid @RequestBody AbastecimentoBatchRequest request) {

        validateIntegrationKey(integrationKey);

        IntegrationResult result =
                abastecimentoService.create(request, configuration(competencia), integrationClient());
